...
/*
/* textPortion: RECORD_DATA_LEN bytes allocated for text
...
public class Record  {
	...
	if (error == Globals.PROCESS_OK) {
	    data[0] = (byte) Globals.DELETED;
            next = Globals.END_OF_MESSAGE;  // added this line of code on June 14, 2018 - it does not apply to 2018 exam
